...
<?php
$sql = mysql_query("select * from pengumuman where jenis_pengumuman='Khusus' order by id_pengumuman desc");
$no=1;
...
<td class='td' width='26%' ><span class="style3"><?echo TanggalIndo($r['tgl_posting']);?></span></td>
<td class='td' width='42%' ><span class="style3"><?echo"$r[judul]";?></span></td>

<td class='td' align="center"><span class="style3"><a href='./img_galeri/<?echo"$r[file]";?>'>Download</a> </td>
