...
tinyMCE.init({
  ...
  <img class='img-left framed' width=60 src='img/nofoto.jpg' border=0 class>
  ...
  <a href="media.php?module=kategori">
   KATEGORI </a>
   <li>
  <a href="media.php?module=komentar">
   KOMENTAR BERITA</a>
   <li>
  <a href="media.php?module=agenda">
   AGENDA</a>
   <li>
  <a href="media.php?module=pengumuman">
   PENGUMUMAN</a>
  
  <li>
  <a href="media.php?module=lakip">
   LAKIP</a>
   <li>
  <a href="media.php?module=pegawai">
   PEGAWAI</a>
 <li>
  <a href="media.php?module=galerifoto">
   GALLERY FOTO</a>
  <li>
  <a href="logout.php">
   LOGOUT</a> 
